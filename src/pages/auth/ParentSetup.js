...
export default function ParentSetup() {
  ...
  function totalPrefs() {
    return prefs.chess + prefs.coding + prefs.typing;
  }
  ...
  function adjustPref(subject, delta) {
    setPrefs(p => {
      ...
      if (otherTotal === 0) return newPrefs;
    ...
    <div className="setup-page">
      <div className="setup-card">
        ...
        <p className="setup-sub">
          You'll create a profile for each child — including a 4-digit PIN they use to log in
          and a personalised learning schedule.
        </p>
    ...
    <div className="setup-page">
      <div className="setup-card setup-card-wide">
        ...
        <div className="setup-progress">
          ...
          <div className="setup-prog-divider" />
          <div className="setup-prog-step">3. Learning preferences</div>
        </div>
        ...
        <div className="field">
          ...
          <input className="field-input" type="number" min="6" max="13" placeholder="Between 6 and 13"
          ...
          <div className="avatar-picker">
            {AVATARS.map((av, i) => (
              <button
                ...
                style={avatar === av ? { background: avatarColor, borderColor: avatarColor } : {}}
        ...
        <div className="setup-preview">
          <div className="setup-preview-avatar" style={{ background: avatarColor }}>
            {avatar}
          </div>
          <div className="setup-preview-name">
            {childName || 'Your child'}, {childAge || '—'}
          </div>
        </div>
  ...
  if (step === 'pin') return (
    <div className="setup-page">
      <div className="setup-card setup-card-wide">
        ...
        <p className="setup-sub">Your child uses this PIN to log in. Keep it simple — something they can remember.</p>
    ...
    <div className="setup-page">
      <div className="setup-card setup-card-wide">
        ...
        <div className="setup-progress">
          ...
          <div className="setup-prog-divider" />
          <div className="setup-prog-step setup-prog-active">3. Learning preferences</div>
        </div>

        <h2 className="setup-section-title">How should {childName} spend their learning time?</h2>
        <p className="setup-sub">
          Set how much of each daily session is devoted to each skill.
          Total must equal 100%. You can change this anytime.
        </p>
        ...
        <div className={`prefs-total ${totalPrefs() === 100 ? 'prefs-total-ok' : 'prefs-total-err'}`}>
          Total: {totalPrefs()}% {totalPrefs() === 100 ? '✓' : `— needs to equal 100%`}
        </div>
  ...
  if (step === 'done') return (
    <div className="setup-page">
      <div className="setup-card">
        ...
        <button className="setup-btn-secondary" style={{ marginTop: 10 }}
          onClick={() => {
