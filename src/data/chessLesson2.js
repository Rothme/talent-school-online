    ...
    // ═══════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        },
        {
          ...
          voice: `Next time, {name}, we learn HOW the Rook and Bishop actually MOVE around the board! Watch the Rook slide straight up the file and across the rank — those are straight lines! And the Bishop glides diagonally — it has a colour secret you will find amazing. Everything you learned today — especially R for Rook and B for Bishop — will come straight to life in Lesson 3. See you next session!`,
          task: null,
          taskType: 'complete',
