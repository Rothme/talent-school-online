    ...
    // ═══════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        },
        {
          ...
          highlights: [],
          pieceLetterRef: [{ icon: '♗', letter: 'B', name: 'Bishop' }],
          voice: `From c1, diagonally up-left to a3. All dark squares!`,
          task: null,
          taskType: 'observe',
          continueLabel: 'Last move!',
        },
        {
          ...
          highlights: [],
          pieceLetterRef: [{ icon: '♗', letter: 'B', name: 'Bishop' }],
          voice: `And from a3 all the way back to f8! The Black Bishop visited f8, h6, c1, a3 — they are ALL dark squares! This is the Bishop's great secret — it is locked to ONE colour forever. The White c1 Bishop stays on DARK squares. The Black f8 Bishop stays on DARK squares too. The colour NEVER changes!`,
          task: null,
          taskType: 'observe',
    ...
    // ═══════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        },
        {
          ...
          voice: `The Bishop controls DIAGONAL lines — four diagonal directions spreading outward — thirteen squares from the centre. The X shape of pure diagonals. Together with straight-line movement, diagonals cover every type of line on a chessboard — and very soon you will meet ONE single piece that combines BOTH at once. But that is next lesson, {name}!`,
          task: null,
          taskType: 'observe',
    ...
    // ═══════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        },
        {
          ...
          boardState: 'empty',
          highlights: [],
          voice: `Quick question. The Rook moves in straight lines. How many squares can it reach from the centre of the board?`,
          task: null,
          taskType: 'recap-quiz',
          recapQuestion: 'How many squares can a Rook reach from the centre?',
          recapOptions: ['Fourteen','Eight','Twenty-one','Seven'],
          recapCorrect: 0,
          recapCorrectVoice: `Fourteen. Seven up and down. Seven left and right. Fourteen total. You know your Rook.`,
          recapWrongVoice: `Fourteen squares. Seven along the file. Seven along the rank. Fourteen total from the centre.`,
        },
        {
          id: 'wu1c',
          type: 'wrapup',
          boardState: 'empty',
          highlights: [],
          voice: `One more. Which square colour does a Bishop starting on a dark square always stay on?`,
          task: null,
          taskType: 'recap-quiz',
